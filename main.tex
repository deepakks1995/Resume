...
\section{Work Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \item {
            Build image classifiers (Mobilenet), train multiple object detection models like Mask-RCNN, Faster-RCNN etc. \small{\textbf{\textit{(Tensorflow, Keras, Python)}}}
        }
        \vspace{-2pt}
        \item {
            Deployed tensorflow models to server and mobile \small{\textbf{\textit{(TensorFlow Serving, TFLite, Docker, Nginx)}}}
        }
        \vspace{-2pt}
        \item {
            Built parser library for multiple documents, extracting fields from response of Google Vision API \small{\textbf{\textit{(Java)}}}
        }
        
        \vspace{-2pt}
        \item {
            Built a Document scanner to detect the edges of document while scanning. \small{\textbf{\textit{(OpenCV, Python)}}}
        }
        \vspace{-2pt}
        \item {
            Built a library for handling images mainly text detection (bounding box), noise addition, random background addition, rotation, cropping etc. \small{\textbf{\textit{(Python, OpenCV)}}}
        ...
        \item {
            ...
            enhanced database schema and testing frameworks to accommodate new use cases and built API's. \small{\textbf{\textit{(Java, Spring Boot, Nginx)}}}
        }
        \vspace{-2pt}
        \item {
            Developed a web portal for client on-boarding, service subscription, balance topup. \small{\textbf{\textit{(Angular 6, RxJs)}}}
        }
        
        \item {
            Developed and managed backend API's and android app, requiring QR Code parsing from camera as well as from scanned Pdf, Compressed XML parsing and verifying its signature. \small{\textbf{\textit{(Java, Spring Boot, Android)}}}
        }
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
            \vspace{6pt}
            Developed a data visualisation tool supporting multiple interactive visualisation like Pie Charts, Tree Map, Forced Directed Graphs etc. \small{\textbf{\textit{(AngularJS, D3JS, RickshawJS)}}}
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeNewSubItem{\href{https://github.com/deepakks1995/DeepHashing}{Major Technical Project - DeepHashing}}{(Aug 2017 - May 2018), IIT Mandi}{
      ...
      \end{itemize}
    %   \vspace{-4pt}
      Implemented \href{https://arxiv.org/abs/1801.08360}{DADH} network, as to get the distance between the binary encoding of the bio-metric images. Images were preprocessed using an Auto Encoder which was trained on FVC2002, FVC2004 and FVC2006 dataset. \small{\textbf{\textit{(Tensorflow, Keras, Python, OpenCV)}}}
    }
